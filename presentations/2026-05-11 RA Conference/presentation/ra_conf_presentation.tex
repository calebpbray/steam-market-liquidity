...
\begin{frame}[shrink=20]{Contribution}
	\begin{itemize}
		...
		\end{itemize}
		\item \footnotesize  \textbf{Hedonic Pricing:} Unobservable properties intrinsic to goods (aesthetics, location, etc.) play an important role in pricing and consumer choice \parencites{lancaster_1966}{rosen_1974}{rosen1986}{sirmans_2005}.
		\begin{itemize}
